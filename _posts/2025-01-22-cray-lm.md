...
* Read the documentation and examples at: [Docs](https://docs.cray-lm.com)
* Read deeper into Tokenformer Adaptors, a new method for efficiently training LLMs: [Tokenformer Blog](https://blog.smasint.com/2025/01/22/tokenformer.html)
