## Introducing Craylm: A Unified LLM Inference and Training Platform

Today I am excited to release Craylm version 0.5
...
* Access the source code at: [Github](https://github.com/cray-lm/cray)
* Read the documentation and examples at: [Docs](https://docs.cray-lm.com) | [Code Repair Example](https://blog.cray-lm.com/2025/01/22/code-repair.html)
...
We hope that Craylm will help to democratize access to large language models, and enable more people to build and deploy AI systems that benefit society. We are excited to see what you will build with Craylm!
...
* [SLURM]() and [Kubernetes](https://kubernetes.io) have different worldviews, but pieces of both are useful.
...
We plan to keep Craylm up to date with the latest advances in LLM research, including new models,
